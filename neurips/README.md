...
* download CVE dataset V5 from cve.org: wget <URI> and unzip it into a cveV5 directory in this directory.
* run the fine-tuning script "01".
* run test 17 script with the given parameters
