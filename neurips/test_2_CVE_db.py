...
def main(dataset_root):
    ...
    aspace, gl = (
        ...
        .with_cluster_max_clusters(5000)
        .with_cluster_radius(0.42)
    ...
    for qi, q in enumerate(queries):
        ...
        spear_c_t, kendall_c_t = compute_ranking_metrics(
            results_cosine, results_taumode
        )
        spear_h_t, kendall_h_t = compute_ranking_metrics(
            results_hybrid, results_taumode
        )
